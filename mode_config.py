...
preset_coords: dict[str, tuple[float, float]] = {
    "🌾 전북 김제시 부량면":      (35.7684, 126.8643),
    "🌾 충남 당진시 합덕읍":      (36.8250, 126.7720),
    "🌾 전남 해남군 황산면":      (34.6150, 126.4780),
    "🌿 전북 익산시 함열읍":      (35.9680, 126.9740),
    "🌿 경기 이천시 부발읍":      (37.2890, 127.4420),
    "🌊 충북 충주시 충주호":      (36.9910, 127.9259),
    "🌊 강원 춘천시 소양강댐":    (37.9425, 127.8140),
    "🔥 강원 고성군 토성면":      (38.2250, 128.5110),
    "🔥 경북 안동시 풍천면":      (36.5750, 128.5210),
    "🌧️ 충남 논산시 강경읍":     (36.1570, 126.7800),
    "🌧️ 전남 나주시 다시면":     (35.0230, 126.7310),
    "🌲 강원 홍천군 내면":        (37.6740, 128.4570),
    "🏙️ 서울 성동구 뚝섬":       (37.5285, 127.0675),
    "♨️ 서울 중구":               (37.5665, 126.9780),
    "🏗️ 경기 화성시 동탄2신도시": (37.2060, 127.0900),
    "🏗️ 인천 연수구 송도":        (37.3830, 126.6560),
    "🏭 경북 포항시 남구":         (36.0190, 129.3435),
}
